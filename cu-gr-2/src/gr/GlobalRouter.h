...
public:
    ...
    void dumpCapacities(std::string filename);
    void dumpNets(std::string filename);
...
private:
    ...
    void getGuides(const GRNet& net, vector<std::pair<std::pair<int,int>, utils::BoxT<int>>>& guides) ;
