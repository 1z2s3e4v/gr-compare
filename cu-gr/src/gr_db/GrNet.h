...
public:
    ...
    vector<GrBoxOnLayer> viaRouteGuides; // origin
    vector<GrBoxOnLayer> viaRouteGuides1; // low
    vector<GrBoxOnLayer> viaRouteGuides2; // high
    vector<GrBoxOnLayer> patchRouteGuides; // origin
    vector<GrBoxOnLayer> patchRouteGuides1; // low
    vector<GrBoxOnLayer> patchRouteGuides2; // high
